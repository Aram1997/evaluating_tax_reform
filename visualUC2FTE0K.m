...
for i = 3:2:size(T10, 1)
    delta_c_i10(i, 1) = table2array(T10(i, 4) + T10(i+1, 4)) - table2array(U10(i, 5) + U10(i+1, 5));
    delta_y_i10(i, 1) = table2array(T10(i, 1) + T10(i+1, 1));
    delta_c_i11(i, 1) = table2array(T11(i, 4) + T11(i+1, 4)) - table2array(U11(i, 5) + U11(i+1, 5));
    delta_y_i11(i, 1) = table2array(T11(i, 1) + T11(i+1, 1));
    delta_c_i12(i, 1) = table2array(T12(i, 4) + T12(i+1, 4)) - table2array(U12(i, 5) + U12(i+1, 5));
    delta_y_i12(i, 1) = table2array(T12(i, 1) + T12(i+1, 1));
    delta_c_i13(i, 1) = table2array(T13(i, 4) + T13(i+1, 4)) - table2array(U13(i, 5) + U13(i+1, 5));
    delta_y_i13(i, 1) = table2array(T13(i, 1) + T13(i+1, 1));
    delta_c_i14(i, 1) = table2array(T14(i, 4) + T14(i+1, 4)) - table2array(U14(i, 5) + U14(i+1, 5));
    delta_y_i14(i, 1) = table2array(T14(i, 1) + T14(i+1, 1));
    delta_c_i15(i, 1) = table2array(T15(i, 4) + T15(i+1, 4)) - table2array(U15(i, 5) + U15(i+1, 5));
    delta_y_i15(i, 1) = table2array(T15(i, 1) + T15(i+1, 1));
    delta_c_i16(i, 1) = table2array(T16(i, 4) + T16(i+1, 4)) - table2array(U16(i, 5) + U16(i+1, 5));
...
for i = 4:2:size(T10, 1)
    ...
    T10.gezBrutInk(i/2) = T10.ils_earns(i) + T10.ils_earns(i-1);
    T11.ptrN(i/2) = T11.ptr11(i-1);
    T11.gezBrutInk(i/2) = T11.ils_earns(i) + T11.ils_earns(i-1);
    T12.ptrN(i/2) = T12.ptr12(i-1);
    T12.gezBrutInk(i/2) = T12.ils_earns(i) + T12.ils_earns(i-1);
    T13.ptrN(i/2) = T13.ptr13(i-1);
    T13.gezBrutInk(i/2) = T13.ils_earns(i) + T13.ils_earns(i-1);
    T14.ptrN(i/2) = T14.ptr14(i-1);
    T14.gezBrutInk(i/2) = T14.ils_earns(i) + T14.ils_earns(i-1);
    T15.ptrN(i/2) = T15.ptr15(i-1);
    T15.gezBrutInk(i/2) = T15.ils_earns(i) + T15.ils_earns(i-1);
    T16.ptrN(i/2) = T16.ptr16(i-1);
    T16.gezBrutInk(i/2) = T16.ils_earns(i) + T16.ils_earns(i-1);
end
