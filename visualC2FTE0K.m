...
for i = 3:2:size(T10, 1)
    ...
    delta_y_i10(i, 1) = table2array(T10(i, 1) + T10(i+1, 1) - T10(i-1, 1) - T10(i-2, 1));
    delta_c_i11(i, 1) = table2array(T11(i, 4) + T11(i+1, 4) - T11(i-1, 4) - T11(i-2, 4));
    delta_y_i11(i, 1) = table2array(T11(i, 1) + T11(i+1, 1) - T11(i-1, 1) - T11(i-2, 1));
    delta_c_i12(i, 1) = table2array(T12(i, 4) + T12(i+1, 4) - T12(i-1, 4) - T12(i-2, 4));
    delta_y_i12(i, 1) = table2array(T12(i, 1) + T12(i+1, 1) - T12(i-1, 1) - T12(i-2, 1));
    delta_c_i13(i, 1) = table2array(T13(i, 4) + T13(i+1, 4) - T13(i-1, 4) - T13(i-2, 4));
    delta_y_i13(i, 1) = table2array(T13(i, 1) + T13(i+1, 1) - T13(i-1, 1) - T13(i-2, 1));
    delta_c_i14(i, 1) = table2array(T14(i, 4) + T14(i+1, 4) - T14(i-1, 4) - T14(i-2, 4));
    delta_y_i14(i, 1) = table2array(T14(i, 1) + T14(i+1, 1) - T14(i-1, 1) - T14(i-2, 1));
    delta_c_i15(i, 1) = table2array(T15(i, 4) + T15(i+1, 4) - T15(i-1, 4) - T15(i-2, 4));
    delta_y_i15(i, 1) = table2array(T15(i, 1) + T15(i+1, 1) - T15(i-1, 1) - T15(i-2, 1));
    delta_c_i16(i, 1) = table2array(T16(i, 4) + T16(i+1, 4) - T16(i-1, 4) - T16(i-2, 4));
    delta_y_i16(i, 1) = table2array(T16(i, 1) + T16(i+1, 1) - T16(i-1, 1) - T16(i-2, 1));
end
...
figure
plot(x(2:8501, 1), y0(2:8501, 1), 'b', x(2:8501, 1), y3(2:8501, 1), 'c')
legend('no reform' , 'marital coefficent reform')